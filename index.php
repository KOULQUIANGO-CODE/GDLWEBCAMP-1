<?php include_once 'includes/templates/header_index.php'; ?>
<main>
    <section class="seccion contenedor">
        <h2>La mejor conferencia de desiño web en español</h2>
        <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quam, libero corrupti! Molestias temporibus ut
            corrupti. Explicabo commodi consectetur similique vel, quia ratione sint quam ducimus aspernatur atque,
            ullam adipisci tenetur!
        </p>
    </section>

    <section class="programa">
        <div class="contenedor-video">
            <video onloadedmetadata="this.muted=true" autoplay loop poster="img/bg-talleres.jpg">
                ...
                <div class="programa-evento">
                    ...
                    <nav class="menu-programa">
                        ...
                        <a href="#<?php echo strtolower($categoria['cat_evento']) ?>">
                            ...
                            <?php echo ($categoria['cat_evento']) ?></a>
                        <?php } ?>
  ...
  <?php include_once 'includes/templates/footer_index.php'; ?>
